...
{
    public class FetchCampaignsResponse
    {
        [JsonProperty("data")]
        public List<Datum> Data { get; set; }

        [JsonProperty("links")]
        public CampaignsLinks Links { get; set; }

        [JsonProperty("meta")]
        public CampaignsMeta Meta { get; set; }
        public class Datum
        {
