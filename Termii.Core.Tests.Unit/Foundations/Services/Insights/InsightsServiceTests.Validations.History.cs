...
namespace Termii.Core.Tests.Unit.Foundations.Services.Insights
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSearchIfEmailInsightsIsNullAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnSearchIfSearchRequestIsNullAsync()
        {
            // given
        ...
        [InlineData("", "")]
        [InlineData("  ", "  ")]
        public async Task ShouldThrowValidationExceptionOnPostSearchIfSearchRequestIsInvalidAsync(
            string invalidApiKey, string invalidPhoneNumber)
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnPostSearchIfPostSearchRequestIsEmptyAsync()
        {
            // given
            var Search = new Search
            {
