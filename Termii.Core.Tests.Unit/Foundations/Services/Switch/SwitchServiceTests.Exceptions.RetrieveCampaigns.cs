...
namespace Termii.Core.Tests.Unit.Foundations.Services.Switch
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnFetchCampaignsRequestIfUrlNotFoundAsync()
        {
            // given
            ...
            // when
            ValueTask<FetchCampaigns> retrieveFetchCampaignsTask =
               this.switchService.GetCampaignsRequestAsync(apiKey);

            SwitchDependencyException
                actualSwitchDependencyException =
                    await Assert.ThrowsAsync<SwitchDependencyException>(
                        retrieveFetchCampaignsTask.AsTask);
        ...
        public async Task ShouldThrowDependencyExceptionOnFetchCampaignsRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchCampaignsRequestIfNotFoundOccurredAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchCampaignsRequestIfBadRequestOccurredAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchCampaignsRequestIfTooManyRequestsOccurredAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnFetchCampaignsRequestIfHttpResponseErrorOccurredAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnFetchCampaignsRequestIfServiceErrorOccurredAsync()
        {
            // given
