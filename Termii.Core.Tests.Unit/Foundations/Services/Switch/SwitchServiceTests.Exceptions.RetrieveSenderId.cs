...
namespace Termii.Core.Tests.Unit.Foundations.Services.Switch
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnFetchSenderIdRequestIfUrlNotFoundAsync()
        {
            // given
            ...
            // when
            ValueTask<FetchSenderIds> retrieveFetchSenderIdsTask =
               this.switchService.GetSenderIdsRequestAsync(apiKey);

            SwitchDependencyException
                actualSwitchDependencyException =
                    await Assert.ThrowsAsync<SwitchDependencyException>(
                        retrieveFetchSenderIdsTask.AsTask);
        ...
        public async Task ShouldThrowDependencyExceptionOnFetchSenderIdsRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchSenderIdsRequestIfNotFoundOccurredAsync()
        {
            // given
              var apiKey = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchSenderIdsRequestIfBadRequestOccurredAsync()
        {
            // given
              var apiKey = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnFetchSenderIdsRequestIfTooManyRequestsOccurredAsync()
        {
            // given
              var apiKey = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnFetchSenderIdsRequestIfHttpResponseErrorOccurredAsync()
        {
            // given
              var apiKey = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnFetchSenderIdsRequestIfServiceErrorOccurredAsync()
        {
            // given
              var apiKey = GetRandomString();
