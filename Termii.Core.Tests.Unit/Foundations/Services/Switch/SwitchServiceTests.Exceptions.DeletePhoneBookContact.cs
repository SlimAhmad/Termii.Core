...
namespace Termii.Core.Tests.Unit.Foundations.Services.Switch
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnDeletePhoneBookContactRequestIfUrlNotFoundAsync()
        {
            // given
            ...
            // when
            ValueTask<DeletePhoneBookContact> retrieveDeletePhoneBookContactTask =
               this.switchService.DeletePhoneBookContactRequestAsync(apiKey, phoneBookId);

            SwitchDependencyException
                actualSwitchDependencyException =
                    await Assert.ThrowsAsync<SwitchDependencyException>(
                        retrieveDeletePhoneBookContactTask.AsTask);
        ...
        public async Task ShouldThrowDependencyExceptionOnDeletePhoneBookContactRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnDeletePhoneBookContactRequestIfNotFoundOccurredAsync()
        {
            // given
              var phoneBookId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnDeletePhoneBookContactRequestIfBadRequestOccurredAsync()
        {
            // given
              var phoneBookId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnDeletePhoneBookContactRequestIfTooManyRequestsOccurredAsync()
        {
            // given
              var phoneBookId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnDeletePhoneBookContactRequestIfHttpResponseErrorOccurredAsync()
        {
            // given
              var phoneBookId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnDeletePhoneBookContactRequestIfServiceErrorOccurredAsync()
        {
            // given
              var phoneBookId = GetRandomString();
